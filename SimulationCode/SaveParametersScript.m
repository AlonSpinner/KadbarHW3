...
prm.f_HdynM1=matlabFunction(subs(Hdyn_exp,[H,L,L1,rho,D,M],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D,prm.M1]),'vars',{[t1,t2,d3]'});
prm.f_HdynM2=matlabFunction(subs(Hdyn_exp,[H,L,L1,rho,D,M],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D,prm.M2]),'vars',{[t1,t2,d3]'});
%% Computing Cdyn
...
%     for j=1:3
%         for k=1:3
%             c_ijk(i,j,k)=0.5*(diff(Hdyn(i,j),q(k))+diff(Hdyn(i,k),q(j))-diff(Hdyn(k,j),q(i)));
%         end
%     end
% end
% 
...
%     for j=1:3
%         for k=1:3
%             Cdyn(i,j)=c_ijk(i,j,k)*qdot(k)+Cdyn(i,j);
%         end
%     end
% end
...
Cdyn_exp=subs(Cdyn,[m1,m2,m3,m4],...
    [m1exp,m2exp,m3exp,m4exp]);
prm.f_CdynM1=matlabFunction(subs(Cdyn_exp,[H,L,L1,rho,D,M],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D,prm.M1]),...
    'vars',{[t1,t2,d3,t1dot,t2dot,d3dot]'});
prm.f_CdynM2=matlabFunction(subs(Cdyn_exp,[H,L,L1,rho,D,M],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D,prm.M2]),...
    'vars',{[t1,t2,d3,t1dot,t2dot,d3dot]'});
...
Gdyn_exp=subs(Gdyn,[m1,m2,m3,m4],...
    [m1exp,m2exp,m3exp,m4exp]);
prm.f_GdynM1=matlabFunction(subs(Gdyn_exp,[H,L,L1,rho,D,M,g],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D,prm.M1,prm.g]),'vars',{[t1,t2,d3]'});
prm.f_GdynM2=matlabFunction(subs(Gdyn_exp,[H,L,L1,rho,D,M,g],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D,prm.M2,prm.g]),'vars',{[t1,t2,d3]'});
%% Test
disp('Hdyn symmetric?');
